<template>
  <section class="py-16 bg-white">
    ...
    <div class="max-w-7xl mx-auto px-4 text-center">
      <p class="text-primary-600 font-semibold uppercase tracking-wide">Категории</p>
    ...
    <div v-if="topLevelCategories.length" class="mt-12 max-w-7xl mx-auto px-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        >
          <!-- Иконка -->
          <div class="bg-primary-600 text-white p-4 rounded-full inline-flex items-center justify-center mb-4">
