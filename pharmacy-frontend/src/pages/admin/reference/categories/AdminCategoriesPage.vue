<template>
  <div class="flex w-full" v-if="loaded">
    <div class="w-1/3 pr-6 border-r">
      <div class="mb-4 text-right">
        <el-button size="small" type="primary" @click="createCategory">Создать</el-button>
      </div>
      <el-tree
        :data="categories"
        node-key="id"
    ...
    <div class="flex-1 pl-6" v-if="selected">
      ...
      <div class="mb-4">
        <el-button size="small" type="primary" @click="openEdit">Редактировать</el-button>
        <el-button size="small" type="danger" @click="removeCategory">Удалить</el-button>
      </div>
      <div>
