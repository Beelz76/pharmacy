        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsmId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ref_OrderStatuses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Ref_PaymentMethods",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ref_PaymentMethods", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Ref_PaymentStatuses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ref_PaymentStatuses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Ref_ProductCategories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ref_ProductCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ref_ProductCategories_Ref_ProductCategories_ParentCategoryId",
                        column: x => x.ParentCategoryId,
                        principalTable: "Ref_ProductCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategoryFields_Ref_ProductCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_Ref_ProductCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Ref_ProductCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Ref_OrderStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Ref_OrderStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_Ref_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "Ref_PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Ref_PaymentStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Ref_PaymentStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deliveries_UserAddresses_UserAddressId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ожидает оплаты", "WaitingForPayment" },
                    { 2, "Ожидает обработки", "Pending" },
                    { 3, "В обработке", "Processing" },
                    { 4, "Готов к получению", "ReadyForReceive" },
                    { 5, "Получен", "Received" },
                    { 6, "Отменен", "Cancelled" },
                    { 7, "Возврат средств", "Refunded" },
                    { 8, "Передан в доставку", "OutForDelivery" },
                    { 9, "Доставлен", "Delivered" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Картой онлайн", "Online" },
                    { 2, "При получении", "OnDelivery" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "EmailVerified", "FirstName", "LastName", "PasswordHash", "Patronymic", "PharmacyId", "Phone", "Role" },
                values: new object[,]
                {
                    { 1, "admin@example.com", true, "test", "test", "2C7C7E374A42F485DBB90E8C19C1B9CEA0BD13EF67816BB8F8A70FCD47F0B9AA-02286835EA819C04E58E380AD9C0A8AF", null, null, null, "Admin" },
                    { 2, "employee@example.com", true, "test", "test", "2C7C7E374A42F485DBB90E8C19C1B9CEA0BD13EF67816BB8F8A70FCD47F0B9AA-02286835EA819C04E58E380AD9C0A8AF", null, null, null, "Employee" },
                    { 3, "user@example.com", true, "test", "test", "2C7C7E374A42F485DBB90E8C19C1B9CEA0BD13EF67816BB8F8A70FCD47F0B9AA-02286835EA819C04E58E380AD9C0A8AF", null, null, null, "User" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_UserAddressId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategoryFields_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProperties_Key_Value",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ref_ProductCategories_Name",
                table: "Ref_ProductCategories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Ref_ProductCategories_ParentCategoryId",
                table: "Ref_ProductCategories",
